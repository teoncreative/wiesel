...
class ScriptVec3 {
 public:
  ScriptVec3(glm::vec3& backingVec3, bool* changedPtr)
      : m_BackingVec3(backingVec3), m_ChangedPtr(changedPtr) {}
...
struct ScriptTransformComponent {
  ScriptTransformComponent(TransformComponent& transform)
      : Transform(transform),
  ...
  void SetScale2(const glm::vec3& scale) {
