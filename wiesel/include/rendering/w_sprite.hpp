...
class SpriteAsset {
 public:
  ...
  void UpdateTransform(glm::mat4 transform_matrix, const glm::vec4& tint,
                       bool flip_x, bool flip_y, int frame_index = -1);
...
enum class AddFrameResult { Success, UVSizeShouldBeLargerThanZero };
...
class SpriteBuilder {
 public:
  ...
  AddFrameResult AddFrame(float_t duration_seconds, glm::vec2 uv_pos,
                          glm::vec2 uv_size = {0, 0});
