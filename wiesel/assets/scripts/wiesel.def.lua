...
function TransformComponent:Move(dx, dy, dz)
end
...
function TransformComponent:SetPosition(x, y, z)
end
...
---@param dz number
---@overload fun(delta: Vec3)
function TransformComponent:Rotate(dx, dy, dz)
end
...
function TransformComponent:SetRotation(x, y, z)
end
...
---@param dz number
---@overload fun(delta: Vec3)
function TransformComponent:Resize(dx, dy, dz)
end
...
function TransformComponent:SetScale(x, y, z)
end
