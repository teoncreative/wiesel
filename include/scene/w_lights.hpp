...
namespace Wiesel {
  ...
  struct alignas(16) LightBase {
    LightBase() : Color({1.0f, 1.0f, 1.0f}),
                  Ambient(0.05f),
                  Diffuse(1.0f),
                  Specular(1.0f),
                  Density(1.0f) {}
    LightBase(glm::vec3 color, float density, float ambient) : Color(color),
                                                               Density(density),
                                                               Ambient(ambient) {}
    ~LightBase() = default;
  ...
  struct alignas(16) LightDirect {
    ...
    LightDirect(glm::vec3 direction, LightBase base) : Direction(direction),
                                                       Base(base) {}
    ~LightDirect() = default;
  ...
  struct alignas(16) LightPoint {
    LightPoint() : Position({0.0f, 1.0f, 0.0f}),
                   Constant(1.0f),
                   Linear(0.09f),
                   Exp(0.032f) {}
    LightPoint(glm::vec3 position, LightBase base, float constant, float linear, float quadratic) : Position(position),
                                                                                                    Base(base),
                                                                                                    Constant(constant),
                                                                                                    Linear(linear),
                                                                                                    Exp(quadratic) {}
  ...
  struct alignas(16) LightsUniformBufferObject {
    LightsUniformBufferObject() : DirectLightCount(0),
                                  PointLightCount(0){};
