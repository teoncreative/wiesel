...
namespace Wiesel {
  ...
  struct SamplerProps {
    SamplerProps() : MagFilter(VK_FILTER_LINEAR),
                     MinFilter(VK_FILTER_LINEAR),
                     MaxAnisotropy(-1.0f) {}
    SamplerProps(VkFilter magFilter, VkFilter minFilter, float anisotropy) : MagFilter(magFilter),
                                                                             MinFilter(minFilter),
  ...
  struct TextureProps {
    TextureProps() : Type(TextureTypeDiffuse),
                     GenerateMipmaps(true),
                     ImageFormat(VK_FORMAT_R8G8B8A8_SRGB) {}
    TextureProps(TextureType type) : Type(type),
                                     GenerateMipmaps(true),
                                     ImageFormat(VK_FORMAT_R8G8B8A8_SRGB) {}
    TextureProps(TextureType type, bool generateMipmaps, VkFormat imageFormat, VkFilter magFilter, VkFilter minFilter) : Type(type),
