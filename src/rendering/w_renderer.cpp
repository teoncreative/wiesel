...
namespace Wiesel {
	...
	Reference<Texture> Renderer::CreateTexture(const std::string& path, TextureProps textureProps, SamplerProps samplerProps) {
	...
	Reference<DescriptorData> Renderer::CreateDescriptors(Reference<UniformBufferSet> uniformBufferSet, Reference<Material> material) {
